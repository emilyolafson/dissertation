...
\begin{figure}\includegraphics[width=1\linewidth]{chapter3/SMATT.png}
...
\begin{figure}[h!]
  ...
  \caption*{8 functtional networks identified by (\cite{Finn2015-er}) by clustering healthy functional connectivity matrices.}
...
\begin{figure}[h!]
    ...
    \centering
    \includegraphics[width=\textwidth]{chapter1/SupplementaryFigure5.png}
...
\begin{figure}[h!]
    ...
    \centering
    \includegraphics[width=\textwidth]{chapter1/SupplementaryFigure7.png}
       \caption{Functional network visualizations.}
  \caption*{8 functtional networks identified by (\cite{Finn2015-er}) by clustering healthy functional connectivity matrices.}
